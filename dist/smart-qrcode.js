    ...
    return function(modules) {
        ...
        function Logo() {
            ...
            props = _objectWithoutPropertiesLoose(_ref2, venmo_logo_excluded), svg = (_ref = function(name, logoColorMap, logoColor) {
                ...
                return "https://www.paypalobjects.com/js-sdk-logos/2.2.4/" + function(logoName, logoColor) {
        ...
        function setupNativeQRLogger() {
            ...
            logger.addTrackingBuilder((function() {
                ...
                _ref2.context_id = orderID, _ref2.button_session_id = buttonSessionID, _ref2.button_version = "5.0.128", 
